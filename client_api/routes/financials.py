...
financials_router_client = APIRouter()
...
@financials_router_client.get("/cash_flow", response_model=List[FinancialRecord])
...
@financials_router_client.get("/balance_sheet", response_model=List[FinancialRecord])
...
@financials_router_client.get("/income", response_model=List[FinancialRecord])
